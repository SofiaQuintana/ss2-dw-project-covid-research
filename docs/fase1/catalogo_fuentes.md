...
> **Nota:** Las imágenes deben colocarse en `docs/assets/renap/` con los nombres `renap_email.png`, `renap_form_p1.png` y `renap_form_p2.png`. Los originales están disponibles en el documento `[SS2]Proyecto.md` del equipo.
